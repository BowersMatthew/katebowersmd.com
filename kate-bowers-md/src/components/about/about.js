        ...
        <section className="about">
            ...
            <div className="content">
                ...
                <div className="right">
                    ...
                    <p> Everyone's time is important. Therefore, all visits at Firefly Pediatrics are run on a schedule. You may call or send us a message through the portal to schedule a sick visit. In order for each patient to receive the proper care, we need to know the reason for your appointment. This will allow us to schedule the appropriate amount of time for your visit. Don't worry, we will always strive to have same day sick appointments available.</p>
                    <div>
                    ...
                    <div>
                        ...
                        <p><span style={{fontWeight: 'bold'}}>Directions: </span>Turn as though going to the KinderCare Daycare across Genito from the Exxon. Then take the first left into our parking lot. We are in the second building next to the Ameriprise.</p>
