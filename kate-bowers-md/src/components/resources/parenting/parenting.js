...
const Parenting = () => {
    ...
    return (
        <section className="parenting">
            ...
            <p className="fuller">The deal with parenting is you really can't take advice from anyone. What works for other people's kids may or may not work for yours, and different kids have different personalities. That being said, I do think getting a variety of ideas from different perspectives is helpful. Certain ideologies and practices will fit your family well for a few seasons or during a certain developmental stage, but will then need to be replaced as time goes on. The real challenge of parenthood is learning to be adaptable. Delve into these resources, have a open mind, but don't spend time agonzing about doing it "right". In many cases some of these resources will contradict eachother. There is no ONE way to parent. Some days you'll feel like a boss, some days like a failure. This still happens when you're a pediatrician and a parent. Families are messy, but you'll find your way. Trust your gut!  </p>
            </div>
